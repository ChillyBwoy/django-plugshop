...
from plugshop.views import (ProductListView, ProductView, CategoryListView, 
                            CategoryView, CartView, OrderView, OrderCreateView)
...
urlpatterns = patterns('plugshop.views',
    ...
    url(r'^order/(?P<number>[\-\/\w]+)$', OrderView.as_view(), name='order'),
